...
while pokeball!="1" or pokeball!="2" or pokeball!="3": 
    pokeball = input("")
    print(f"Generazione del tuo pokémon...")
    time.sleep(2)
    if player_name == "/administrator_N3rDiaz" or player_name == "/administrator_NicogiocTV" or player_name == "/administrator_deel" :
        ...
        next=input()
        pokemon="ᒲ╎ᓭᓭ╎リ ⊣リ𝙹"          # traduzione di "Missigno" dal linguaggio enchanting table
    ...
    if choice_combat == "si" or choice_combat == "SI" or choice_combat == "Si" :
        ...
        while not(lp<=0 or elp<=0):
            ...
            if elp<=0:
                ...
                print(f"\nHai vinto la battaglia. Esperienza ottenuta: {battle_exp}")
