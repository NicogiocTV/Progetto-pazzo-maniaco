...
from playsound import playsound        # utilizzo il modulo playsound per utilizzare file audio nel programma
import pygame
from pygame import mixer               # importo la funzione "mixer" da pygame per riprodurre il file audio in background. Pygame è una libreria potente ma a noi serve solo per la colonna sonora
...
mixer.music.set_volume(0.1)            # regolazione del volume
# Menù iniziale------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
print("")
...
while choice_combat != "no" or choice_combat != "NO" or choice_combat != "No" :
    if choice_combat == "si" or choice_combat == "SI" or choice_combat == "Si" or choice_combat == "s" or choice_combat == "S" :
        ...
        while not(lp1<=0 or elp<=0):
            ...
            print(f"{fg(222)}\n╔═{lp:.0f} I tuoi HP                                       HP avversario {elp:.0f}═╗{attr(0)}")
            ...
            if spe >= espe :
                ...
                if option=="attacco" or option=="1": 
                    ...
                    if miss_perc < 90: 
                        ...
                        print("il pokémon avversario a schivato l'attacco ")
                ...
                if enemy_attack==1:
                    ...
                    if miss_perc < 90:
                        ...
                        print(f"Il tuo {pokemon} ha schivato l'attacco ")
