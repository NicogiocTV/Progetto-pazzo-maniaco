...
print(f"Caricamento...")
time.sleep(3)           # il comando serve per fermare il programma e poi farlo ripartire dopo il numero di secondi specificati fra parentesi
# Creazione personaggio-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
calem = climage.convert("CalemXY.jpg", is_256color=True, width=50, is_unicode=True)          # converte l'immagine in formato ANSI e gli assegna una variabile,
